...
func GimBody() TemplateDef {
	...
	body := TemplateDef{
		...
		33:  AsciiVar(2, 11, fieldValidator.Ans()),
		...
		55:  AsciiVar(3, 999, fieldValidator.None()),
		56:  AsciiVar(2, 35, fieldValidator.N()),
		60:  AsciiVar(3, 999, fieldValidator.Ans()),
		61:  AsciiVar(3, 999, fieldValidator.None()),
...
func GimEcho() map[string]string{
